...
import watchImage from '../../assets/hero-1.png';
      ...
      <div className='hero-slider__item'>
        <div className='hero__content'>
          <div className='hero__image'>
            <img src={watchImage} alt='watchImage' />
          </div>
          <div className='hero__info'>
            <h1 className='hero__title'>WAY KAMBAS MINI EBONY</h1>
            <p className='hero__description'>
              MATOA Way Kambas - This wood is chosen to represent the Sumatran Rhino's skin which is
              designed with an overlap effect on its strap to represent Rhino's skin.
            </p>
            <a href='' className='hero__discover discover-link'>
              Discover
            </a>
            <div className='hero__buttons'>
              <button className='hero__add-cart'>
                <svg
                  width='32'
                  height='32'
                  viewBox='0 0 32 32'
      ...
      <div className='hero-slider__item'>
        <div className='hero__content'>
          ...
          <div className='hero__info'>
            ...
            <a href='' className='hero__discover'>
              Discover
            </a>
            <div className='hero__buttons'>
              <button className='hero__add-cart'>
